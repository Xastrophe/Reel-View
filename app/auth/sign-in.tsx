    ...
    <SafeAreaView style={styles.container}>
      <View style={styles.view}>
        ...
        <View style={styles.form}>
          ...
          <AntDesign name="user" size={25} style={styles.googlelogo}/>
            <TextInput
              style={styles.input}
              value={form.email}
      ...
      <View style={styles.footer}>
                <Text style={styles.footertitle}>Already have an account? <Link style={styles.signupLabel} href='/auth/login'> Sign Up </Link></Text>
              </View>
    </SafeAreaView>
  );
}
